...
impl Agent for SystemAgent {
    ...
    fn description(&self) -> &str {
        "Handles OS configuration, package management, and system administration."
    }
...
impl Agent for CoderAgent {
    ...
    fn description(&self) -> &str {
        "Handles coding tasks, git operations, and file editing."
    }
...
impl Agent for VerifierAgent {
    ...
    fn description(&self) -> &str {
        "Critiques and verifies the response against the user prompt."
    }
